...
export function SolidGrandMasters(props: { loading: Element }) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	element = props.loading;
	return <>{element}{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.ScoredNightFall, displayInactive: false, loading: props.loading })}</>;
}

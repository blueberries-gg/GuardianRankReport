...
function GetDisplayItemDungeon(props: { item: IDisplayActivity, loading: Element }) {
	return (
		<tr>
			<td></td>
...
function GetDisplayItems(props: { item: IDisplayActivity; activityType: ActivityType, loading: Element }) {
	switch (props.activityType) {
		case ActivityType.Dungeon:
...
function DisplayActivities(props: { activities: Map<keyof typeof DestinyActivity, IDisplayActivity>; activityType: ActivityType; displayInactive: boolean, loading: Element }) {
...
export function SolidRaids(spinner: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.Raid, displayInactive: true, loading: spinner })}</>;
}
export function SolidDungeons(spinner: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.Dungeon, displayInactive: true, loading: spinner })}</>;
}
export function SolidExoticMissions(spinner: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.ExoticMission, displayInactive: true, loading: spinner })}</>;
}
export function SolidGrandMasters(spinner: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.ScoredNightFall, displayInactive: false, loading: spinner })}</>;
}

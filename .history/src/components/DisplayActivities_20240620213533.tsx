...
export function SolidRaids(loading: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.Raid, displayInactive: true, loading: loading })}</>;
}
export function SolidDungeons(loading: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.Dungeon, displayInactive: true, loading: loading })}</>;
}
export function SolidExoticMissions(loading: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.ExoticMission, displayInactive: true, loading: loading })}</>;
}
export function SolidGrandMasters(loading: Element) {
	const $CurrentPlayerProfile = useStore(CurrentPlayerProfile);
	return <>{DisplayActivities({ activities: $CurrentPlayerProfile().activities, activityType: ActivityType.ScoredNightFall, displayInactive: false, loading: loading })}</>;
}

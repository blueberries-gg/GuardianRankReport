			...
			<td>
				<Show when={mapActivities[props.item.Activity].SoloHash !== undefined}>
					<Show when={props.item.hasSolo == false}>
						<div style="margin: auto; width: 25px;  height: 25px;"><img style="width: 100%;  height: 100%;" src={`${missing.src}`}></img></div>
					</Show>
					<Show when={props.item.hasSolo == true}>
						<div style="margin: auto; width: 25px;  height: 25px;"><img style="width: 100%;  height: 100%;" src={`${complete.src}`}></img></div>
					</Show>
